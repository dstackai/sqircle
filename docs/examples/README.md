...
- `demo.html` renders 96 generated composition presets, including palettes `13..21`, filled `off`/`metal`/`mesh` surfaces, and grained solid/glass variants. Clicking a card changes the main hero composition. Each layer hover remains a state/color swap only.
